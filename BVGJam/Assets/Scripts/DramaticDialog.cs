...
public static class DramaticDialog {
    ...
    public static void setupDramaticDialogs() {
        redGood = new Color(0,0,0,255);
        redBad = new Color(0,0,0,255);
        blueGood = new Color(0,0,0,255);
        blueBad = new Color(0,0,0,255);
        yellowGood = new Color(0,0,0,255);
        yellowBad = new Color(0,0,0,255);
        purpleGood = new Color(0,0,0,255);
        purpleBad = new Color(0,0,0,255);
        greenGood = new Color(0,0,0,255);
        greenBad = new Color(0,0,0,255);
